            ...
            steps {
                script {
                    ...
                    bat """
                        ...
                        pytest ${markerFlag} tests/ --html=reports/report.html --self-contained-html --alluredir=reports/allure-results || exit 0
                    """
                }
            }
        }
    ...
    post {
        ...
        always {
            ...
            script {
                ...
                if (params.REPORT_SELECTION == 'allure' || params.REPORT_SELECTION == 'both') {
